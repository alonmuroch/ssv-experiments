...
// Hash: f35434f0f635dd3ccb0bf8d2b88813a65d02cdcae08e552a9e177e895f1e99e0
// Version: 0.1.2
package types
...
func (c *Cluster) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'Account'
	c.Account = ssz.UnmarshallUint64(buf[16:24])
	...
	// Field (4) 'FaultyNodes'
	c.FaultyNodes = ssz.UnmarshallUint64(buf[28:36])

	// Offset (5) 'Instances'
	if o5 = ssz.ReadOffset(buf[36:40]); o5 > size || o3 > o5 {
		return ssz.ErrOffset
	}
