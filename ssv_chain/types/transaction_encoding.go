...
// Hash: c9cd91c0dc2862808d865b894353582ce047d598001cbbce8351f08582838ba5
// Version: 0.1.2
package types
...
func (s *SignedTransaction) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Offset (2) 'Transaction'
	dst = ssz.WriteOffset(dst, offset)
	offset += s.Transaction.SizeSSZ()

	// Field (1) 'Signer'
	if size := len(s.Signer); size > 128 {
		err = ssz.ErrBytesLengthFn("SignedTransaction.Signer", size, 128)
		return
	}
...
func (s *SignedTransaction) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (2) 'Transaction'
	if o2 = ssz.ReadOffset(buf[1028:1032]); o2 > size || o1 > o2 {
		return ssz.ErrOffset
	}
