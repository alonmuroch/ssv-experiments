...
// Hash: 9708d5075611e976a92d4f3e8ea6b621f70008c249858c05fa629ebe53cf67a4
// Version: 0.1.3
package types
...
func (q *QBFT) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (5) 'StartValue'
	if o5 = ssz.ReadOffset(buf[32:36]); o5 > size || o4 > o5 {
		return ssz.ErrOffset
	}

	// Field (6) 'Stopped'
	q.Stopped = ssz.UnmarshalBool(buf[36:37])
