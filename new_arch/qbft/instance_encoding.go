...
// Hash: 2b1baf7ec08012f1ce0b4d7f826013f6ddc38a485034f8da369d9ec42d611c6c
// Version: 0.1.2
package qbft
...
func (i *Instance) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	dst = ssz.WriteOffset(dst, offset)
	if i.StartValue == nil {
		i.StartValue = new(InputData)
	}
	offset += i.StartValue.SizeSSZ()

	// Offset (4) 'DecidedValue'
	dst = ssz.WriteOffset(dst, offset)
	if i.DecidedValue == nil {
		i.DecidedValue = new(InputData)
	}
	offset += i.DecidedValue.SizeSSZ()
	...
	// Field (4) 'DecidedValue'
	if dst, err = i.DecidedValue.MarshalSSZTo(dst); err != nil {
		return
	}
...
func (i *Instance) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'DecidedValue'
	{
		...
		if err = i.DecidedValue.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	return err
...
func (i *Instance) HashTreeRootWith(hh ssz.HashWalker) (err error) {
	...
	// Field (4) 'DecidedValue'
	if err = i.DecidedValue.HashTreeRootWith(hh); err != nil {
		return
	}
