...
//go:generate go run github.com/ferranbt/fastssz/sszgen --path runner.go --include ./runner_state.go,./container.go,../types/duty.go,../types/consensus_data.go,../types/partial_signature_message.go --exclude-objs PartialSignatureContainer
