...
//go:generate go run github.com/ferranbt/fastssz/sszgen --path runner_state.go --include ../p2p/message.go,../types/partial_signature_message.go,./container.go,../types/duty.go,../types/consensus_data.go,../types/partial_signature_message.go --exclude-objs PartialSignatureContainer
